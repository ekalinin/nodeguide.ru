=========================
Введение. Выбор библиотек
=========================

В рамках данных уроков мы будем делать веб приложение - записную книжку.
Приложение так и назовем - *notepad*. Название не особенно оригинальное,
